...
class LoginForm(BaseForm):
    login = twf.TextField(label=l_('Email'),placeholder=l_('Email'), addon_icon={'right':'glyphicon glyphicon-envelope'})
    password = twf.PasswordField(label=l_('Password'), placeholder=l_('Password'), addon_icon={'right':'glyphicon glyphicon-lock'})
